...
// export const API_BASE_URL = ensureApiPrefix(import.meta.env.VITE_API_BASE_URL || 'http://172.16.150.246:8080')
export const API_BASE_URL = ensureApiPrefix(import.meta.env.VITE_API_BASE_URL || '/api')
