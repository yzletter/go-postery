...
import (
	...
	"github.com/yzletter/go-postery/micro-backend/lottery/errs"
	...
	"github.com/yzletter/go-postery/micro-backend/lottery/service/ports"
)
...
func (svc *lotteryService) rollbackOrderStock(ctx context.Context, order *model2.Order) bool {
