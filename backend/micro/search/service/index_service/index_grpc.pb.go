...
func (c *indexServiceClient) AddDoc(ctx context.Context, in *model.Document, opts ...grpc.CallOption) (*AffectedCount, error) {
...
func (c *indexServiceClient) Count(ctx context.Context, in *CountRequest, opts ...grpc.CallOption) (*AffectedCount, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AffectedCount)
	err := c.cc.Invoke(ctx, IndexService_Count_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedIndexServiceServer) AddDoc(context.Context, *model.Document) (*AffectedCount, error) {
...
func _IndexService_AddDoc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IndexServiceServer).AddDoc(ctx, req.(*model.Document))
	}
...
func _IndexService_Count_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IndexService_Count_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var IndexService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "search/service/index_service/index.proto",
}
