...
import (
	...
	handler2 "github.com/yzletter/go-postery/backend/micro/bff/handler"
	middleware2 "github.com/yzletter/go-postery/backend/micro/bff/middleware"
	service2 "github.com/yzletter/go-postery/backend/micro/bff/service"
)
...
func main() {
	...
	// 加载私有配置
	BFFServiceConf := conf.LoadBFFServiceConfig(ctx, EtcdClient, prefix+ServiceName+"_")
	fmt.Printf("%s Init BFFService Config Success %+v\n", prefix+ServiceName, BFFServiceConf)
