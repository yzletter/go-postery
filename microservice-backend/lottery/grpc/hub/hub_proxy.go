...
//func (proxy *ServiceHubProxy) Register(ctx context.Context, service string, endpoint string, leaseID int64) (int64, error) {
//	return proxy.ServiceHub.Register(ctx, service, endpoint, leaseID)
//}
//
//func (proxy *ServiceHubProxy) Unregister(ctx context.Context, service string, endpoint string) error {
//	return proxy.ServiceHub.Unregister(ctx, service, endpoint)
//}
