...
import (
	...
	session2 "github.com/yzletter/go-postery/microservice-backend/bff/dto/session"
...
type websocketService struct {
	sessionSvc client.SessionClient
...
func NewWebsocketService(sessionSvc client.SessionClient, mq *amqp.Connection) WebsocketService {
