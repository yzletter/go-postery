...
func main() {
	...
	AuthRequiredMiddleWare := AuthHandler.AuthRequired // AuthRequiredMiddleWare 强制登录
	AuthOptionalMiddleWare := AuthHandler.AuthOptional // AuthOptionalMiddleWare 非强制要求登录
